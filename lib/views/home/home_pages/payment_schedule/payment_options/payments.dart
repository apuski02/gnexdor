...
import 'package:nextdoor/views/home/home_pages/payment_schedule/payment_options/p_options/pay_with_card.dart';
import 'package:nextdoor/views/home/home_pages/payment_schedule/payment_options/p_options/pay_with_cash.dart';
import 'package:nextdoor/views/home/home_pages/payment_schedule/payment_options/p_options/pay_with_transfer.dart';
      ...
      body: DefaultTabController(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            backgroundColor: Colors.white,
            centerTitle: false,
            title: Text('Payments', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w400, fontFamily: 'Nato'),),
