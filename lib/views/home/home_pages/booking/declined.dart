...
class Declined_Booking extends StatelessWidget {

  Declined_Booking({super.key});
                              ...
                              children: [
                                ...
                                Container(
                                  //alignment: Alignment.center,
                                    ...
                                    child: Text( 'Declined', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w200,  fontFamily: 'ProximaNovaRegular',  fontSize: 12), )
                                ),
                              ],
                            ),
