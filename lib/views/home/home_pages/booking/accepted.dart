...
class Accepted_Booking extends StatelessWidget {

  Accepted_Booking({super.key});
                              ...
                              children: [
                                ...
                                Container(
                                  //alignment: Alignment.center,
                                    ...
                                    child: Text( 'Accepted', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w200,  fontFamily: 'ProximaNovaRegular',  fontSize: 12), )
                                ),
                              ],
                            ),
