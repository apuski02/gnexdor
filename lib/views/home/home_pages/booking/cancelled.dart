...
class Cancelled_Booking extends StatelessWidget {

  Cancelled_Booking({super.key});
                              ...
                              children: [
                                ...
                                Container(
                                  //alignment: Alignment.center,
                                    ...
                                    child: Text( 'Cancelled', style: TextStyle(color: Colors.black87, fontWeight: FontWeight.w200,  fontFamily: 'ProximaNovaRegular',  fontSize: 12), )
                                ),
                              ],
                            ),
