...
class Forget_Password_New_Password extends StatelessWidget {
  Forget_Password_New_Password({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Center(
                child: Text('Enter New Password', style: TextStyle(fontSize: 18, fontFamily: 'ProximaNovaRegular', color: Color(0xFF2B70B8), fontWeight: FontWeight.bold)),
              ),
              ...
              Center(
                child: Text('Please type your new password below.', textAlign: TextAlign.center, style: TextStyle(fontSize: 16, fontFamily: 'ProximaNovaRegular', fontWeight: FontWeight.w500),),
